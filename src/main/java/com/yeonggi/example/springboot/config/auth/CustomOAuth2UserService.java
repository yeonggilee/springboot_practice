package com.yeonggi.example.springboot.config.auth;

import com.yeonggi.example.springboot.config.auth.dto.OAuthAttributes;
import com.yeonggi.example.springboot.config.auth.dto.SessionUser;
import com.yeonggi.example.springboot.domain.user.User;
import com.yeonggi.example.springboot.domain.user.UserRepository;
...
- 왜 User 클래스를 쓰지 않고 새로 만들어서 쓰는지? p.107, p.188 참고 (Entity 클래스는 DB Layer 클래스)*/
